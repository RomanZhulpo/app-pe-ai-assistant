...
ARG HOLIDAY_HOUR=7
ARG HOLIDAY_MINUTE=1
ARG DAILY_UPDATE_HOUR=6
ARG DAILY_UPDATE_MINUTE=0
ARG LOG_LEVEL=INFO
...
ENV DAILY_UPDATE_HOUR=${DAILY_UPDATE_HOUR}
ENV DAILY_UPDATE_MINUTE=${DAILY_UPDATE_MINUTE}
